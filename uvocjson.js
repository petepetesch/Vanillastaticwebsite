    ...
    "GPM": null,
    "PM": null,
    "Keywords": "#Networking.Migration; #Networking.Usability;"
}    , {
    "@search.score": 15.360976,
...
},
{
    ...
    "Keywords": null
        ...
        var col = [];
        for (var i = 0; i < UVOCJSON.length; i++) {
            for (var key in UVOCJSON[i]) {
        ...
        for (var i = 0; i < UVOCJSON.length; i++) {
            ...
            for (var j = 0; j < col.length; j++) {
                ...
                tabCell.innerHTML = UVOCJSON[i][col[j]];
            }
        }
...
//         // ('Book ID', 'Book Name', 'Category' and 'Price')
//         let col = [];
//         for (let i = 0; i < UVOCJSON.length; i++) {
//             for (let key in UVOCJSON[i]) {
//                 if (col.indexOf(key) === -1) {
//                     col.push(key);
//                 }
//             }
