...
export class SearchClient {
    ...
    getDocumentsCount(options = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const result = yield this.client.documents.count(operationOptionsToRequestOptionsBase(updatedOptions));
    ...
    autocomplete(searchText, suggesterName, options = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const result = yield this.client.documents.autocompletePost(fullOptions, operationOptionsToRequestOptionsBase(updatedOptions));
                return result;
            }
            catch (e) {
                span.setStatus({
    ...
    searchDocuments(searchText, options = {}, nextPageParameters = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const result = yield this.client.documents.searchPost(Object.assign(Object.assign({}, fullOptions), { includeTotalResultCount: fullOptions.includeTotalCount, searchText: searchText }), operationOptionsToRequestOptionsBase(updatedOptions));
    ...
    suggest(searchText, suggesterName, options = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const result = yield this.client.documents.suggestPost(fullOptions, operationOptionsToRequestOptionsBase(updatedOptions));
    ...
    getDocument(key, options = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const result = yield this.client.documents.get(key, operationOptionsToRequestOptionsBase(updatedOptions));
    ...
    batch, options = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const result = yield this.client.documents.index({ actions: serialize(batch.actions) }, operationOptionsToRequestOptionsBase(updatedOptions));
