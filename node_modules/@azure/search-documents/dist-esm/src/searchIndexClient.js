...
export class SearchIndexClient {
    ...
    listSynonymMaps(options = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const result = yield this.client.synonymMaps.list(operationOptionsToRequestOptionsBase(updatedOptions));
    ...
    listSynonymMapsNames(options = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const result = yield this.client.synonymMaps.list(Object.assign(Object.assign({}, operationOptionsToRequestOptionsBase(updatedOptions)), { select: "name" }));
    ...
    getIndex(indexName, options = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const result = yield this.client.indexes.get(indexName, operationOptionsToRequestOptionsBase(updatedOptions));
    ...
    getSynonymMap(synonymMapName, options = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const result = yield this.client.synonymMaps.get(synonymMapName, operationOptionsToRequestOptionsBase(updatedOptions));
    ...
    createIndex(index, options = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const result = yield this.client.indexes.create(utils.publicIndexToGeneratedIndex(index), operationOptionsToRequestOptionsBase(updatedOptions));
                return utils.generatedIndexToPublicIndex(result);
            }
            catch (e) {
                span.setStatus({
    ...
    createSynonymMap(synonymMap, options = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const result = yield this.client.synonymMaps.create(utils.publicSynonymMapToGeneratedSynonymMap(synonymMap), operationOptionsToRequestOptionsBase(updatedOptions));
                return utils.generatedSynonymMapToPublicSynonymMap(result);
            }
            catch (e) {
                span.setStatus({
    ...
    createOrUpdateIndex(index, options = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const result = yield this.client.indexes.createOrUpdate(index.name, utils.publicIndexToGeneratedIndex(index), Object.assign(Object.assign({}, operationOptionsToRequestOptionsBase(updatedOptions)), { ifMatch: etag }));
                return utils.generatedIndexToPublicIndex(result);
            }
            catch (e) {
                span.setStatus({
    ...
    createOrUpdateSynonymMap(synonymMap, options = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const result = yield this.client.synonymMaps.createOrUpdate(synonymMap.name, utils.publicSynonymMapToGeneratedSynonymMap(synonymMap), Object.assign(Object.assign({}, operationOptionsToRequestOptionsBase(updatedOptions)), { ifMatch: etag }));
                return utils.generatedSynonymMapToPublicSynonymMap(result);
            }
            catch (e) {
                span.setStatus({
    ...
    deleteIndex(index, options = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                yield this.client.indexes.delete(indexName, Object.assign(Object.assign({}, operationOptionsToRequestOptionsBase(updatedOptions)), { ifMatch: etag }));
            }
            catch (e) {
                span.setStatus({
                    code: CanonicalCode.UNKNOWN,
            ...
            try {
                ...
                const etag = typeof synonymMap === "string"
                    ...
                    : options.onlyIfUnchanged
                        ? synonymMap.etag
                        : undefined;
                yield this.client.synonymMaps.delete(synonymMapName, Object.assign(Object.assign({}, operationOptionsToRequestOptionsBase(updatedOptions)), { ifMatch: etag }));
            }
            catch (e) {
                span.setStatus({
                    code: CanonicalCode.UNKNOWN,
    ...
    getIndexStatistics(indexName, options = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const result = yield this.client.indexes.getStatistics(indexName, operationOptionsToRequestOptionsBase(updatedOptions));
                return result;
            }
            catch (e) {
                span.setStatus({
    ...
    analyzeText(indexName, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const result = yield this.client.indexes.analyze(indexName, Object.assign(Object.assign({}, restOptions), { analyzer: restOptions.analyzerName, tokenizer: restOptions.tokenizerName }), operationOptionsToRequestOptionsBase(updatedOptions));
                return result;
            }
            catch (e) {
                span.setStatus({
    ...
    getServiceStatistics(options = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const result = yield this.client.getServiceStatistics(operationOptionsToRequestOptionsBase(updatedOptions));
                return result;
            }
            catch (e) {
                span.setStatus({
