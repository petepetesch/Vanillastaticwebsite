...
export class SearchIndexerClient {
    ...
    createIndexer(indexer, options = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const result = yield this.client.indexers.create(utils.publicSearchIndexerToGeneratedSearchIndexer(indexer), operationOptionsToRequestOptionsBase(updatedOptions));
                return utils.generatedSearchIndexerToPublicSearchIndexer(result);
            }
            catch (e) {
                span.setStatus({
    ...
    createDataSourceConnection(dataSourceConnection, options = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const result = yield this.client.dataSources.create(utils.publicDataSourceToGeneratedDataSource(dataSourceConnection), operationOptionsToRequestOptionsBase(updatedOptions));
                return utils.generatedDataSourceToPublicDataSource(result);
            }
            catch (e) {
                span.setStatus({
    ...
    createOrUpdateIndexer(indexer, options = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const result = yield this.client.indexers.createOrUpdate(indexer.name, utils.publicSearchIndexerToGeneratedSearchIndexer(indexer), Object.assign(Object.assign({}, operationOptionsToRequestOptionsBase(updatedOptions)), { ifMatch: etag }));
                return utils.generatedSearchIndexerToPublicSearchIndexer(result);
            }
            catch (e) {
                span.setStatus({
    ...
    createOrUpdateDataSourceConnection(dataSourceConnection, options = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const result = yield this.client.dataSources.createOrUpdate(dataSourceConnection.name, utils.publicDataSourceToGeneratedDataSource(dataSourceConnection), Object.assign(Object.assign({}, operationOptionsToRequestOptionsBase(updatedOptions)), { ifMatch: etag }));
                return utils.generatedDataSourceToPublicDataSource(result);
            }
            catch (e) {
                span.setStatus({
            ...
            try {
                ...
                const etag = typeof indexer === "string"
                    ...
                    : options.onlyIfUnchanged
                        ? indexer.etag
                        : undefined;
                yield this.client.indexers.delete(indexerName, Object.assign(Object.assign({}, operationOptionsToRequestOptionsBase(updatedOptions)), { ifMatch: etag }));
            }
            catch (e) {
                span.setStatus({
                    code: CanonicalCode.UNKNOWN,
            ...
            try {
                ...
                const etag = typeof dataSourceConnection === "string"
                    ...
                    : options.onlyIfUnchanged
                        ...
                        : undefined;
                yield this.client.dataSources.delete(dataSourceConnectionName, Object.assign(Object.assign({}, operationOptionsToRequestOptionsBase(updatedOptions)), { ifMatch: etag }));
            }
            catch (e) {
                span.setStatus({
                    code: CanonicalCode.UNKNOWN,
            ...
            try {
                ...
                const etag = typeof skillset === "string"
                    ...
                    : options.onlyIfUnchanged
                        ? skillset.etag
                        : undefined;
                yield this.client.skillsets.delete(skillsetName, Object.assign(Object.assign({}, operationOptionsToRequestOptionsBase(updatedOptions)), { ifMatch: etag }));
            }
            catch (e) {
                span.setStatus({
                    code: CanonicalCode.UNKNOWN,
