...
class SearchClient$1 {
    ...
    constructor(endpoint, indexName, credential, options = {}) {
        ...
        this.client = new SearchClient(this.endpoint, this.indexName, this.apiVersion, pipeline);
    }
    /**
...
class SearchIndexingBufferedSender {
     ...
     * @param options - Upload options.
     */
    deleteDocuments(documents, options = {}) {
        return tslib.__awaiter(this, void 0, void 0, function* () {
        ...
        return tslib.__awaiter(this, void 0, void 0, function* () {
            if (force || (this.autoFlush && this.isBatchReady())) {
                ...
                while (actions.length > 0) {
                    ...
                    yield this.submitDocuments(batchToSubmit, options);
                }
            }
        });
    }
    ...
    submitDocuments(actionsToSend, options, retryAttempt = 1) {
        return tslib.__awaiter(this, void 0, void 0, function* () {
            try {
                for (const action of actionsToSend) {
                    this.emitter.emit("beforeDocumentSent", action);
                }
                const result = yield this.client.indexDocuments(new IndexDocumentsBatch(actionsToSend), options);
                // raise success event
                ...
                if (e.statusCode && e.statusCode === 413 && actionsToSend.length > 1) {
                    ...
                    for (const actions of splitActionsArray) {
                        yield this.submitDocuments(actions, options);
                    }
                }
                    ...
                    yield coreHttp.delay(delayWithJitter);
                    yield this.submitDocuments(actionsToSend, options, retryAttempt + 1);
                }
                else {
...
class SearchIndexClient {
    ...
    constructor(endpoint, credential, options = {}) {
        ...
        this.client = new SearchServiceClient(this.endpoint, this.apiVersion, pipeline);
    }
    ...
    deleteIndex(index, options = {}) {
        return tslib.__awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                yield this.client.indexes.delete(indexName, Object.assign(Object.assign({}, coreHttp.operationOptionsToRequestOptionsBase(updatedOptions)), { ifMatch: etag }));
            }
            catch (e) {
                span.setStatus({
                    code: api.CanonicalCode.UNKNOWN,
            ...
            try {
                ...
                const etag = typeof synonymMap === "string"
                    ...
                    : options.onlyIfUnchanged
                        ? synonymMap.etag
                        : undefined;
                yield this.client.synonymMaps.delete(synonymMapName, Object.assign(Object.assign({}, coreHttp.operationOptionsToRequestOptionsBase(updatedOptions)), { ifMatch: etag }));
            }
            catch (e) {
                span.setStatus({
                    code: api.CanonicalCode.UNKNOWN,
...
class SearchIndexerClient {
    ...
    createIndexer(indexer, options = {}) {
        return tslib.__awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const result = yield this.client.indexers.create(publicSearchIndexerToGeneratedSearchIndexer(indexer), coreHttp.operationOptionsToRequestOptionsBase(updatedOptions));
                return generatedSearchIndexerToPublicSearchIndexer(result);
            }
            catch (e) {
                span.setStatus({
    ...
    createDataSourceConnection(dataSourceConnection, options = {}) {
        return tslib.__awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const result = yield this.client.dataSources.create(publicDataSourceToGeneratedDataSource(dataSourceConnection), coreHttp.operationOptionsToRequestOptionsBase(updatedOptions));
                return generatedDataSourceToPublicDataSource(result);
            }
            catch (e) {
                span.setStatus({
    ...
    createOrUpdateIndexer(indexer, options = {}) {
        return tslib.__awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const result = yield this.client.indexers.createOrUpdate(indexer.name, publicSearchIndexerToGeneratedSearchIndexer(indexer), Object.assign(Object.assign({}, coreHttp.operationOptionsToRequestOptionsBase(updatedOptions)), { ifMatch: etag }));
                return generatedSearchIndexerToPublicSearchIndexer(result);
            }
            catch (e) {
                span.setStatus({
    ...
    createOrUpdateDataSourceConnection(dataSourceConnection, options = {}) {
        return tslib.__awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const result = yield this.client.dataSources.createOrUpdate(dataSourceConnection.name, publicDataSourceToGeneratedDataSource(dataSourceConnection), Object.assign(Object.assign({}, coreHttp.operationOptionsToRequestOptionsBase(updatedOptions)), { ifMatch: etag }));
                return generatedDataSourceToPublicDataSource(result);
            }
            catch (e) {
                span.setStatus({
            ...
            try {
                ...
                const etag = typeof indexer === "string"
                    ...
                    : options.onlyIfUnchanged
                        ? indexer.etag
                        : undefined;
                yield this.client.indexers.delete(indexerName, Object.assign(Object.assign({}, coreHttp.operationOptionsToRequestOptionsBase(updatedOptions)), { ifMatch: etag }));
            }
            catch (e) {
                span.setStatus({
                    code: api.CanonicalCode.UNKNOWN,
            ...
            try {
                ...
                const etag = typeof dataSourceConnection === "string"
                    ...
                    : options.onlyIfUnchanged
                        ...
                        : undefined;
                yield this.client.dataSources.delete(dataSourceConnectionName, Object.assign(Object.assign({}, coreHttp.operationOptionsToRequestOptionsBase(updatedOptions)), { ifMatch: etag }));
            }
            catch (e) {
                span.setStatus({
                    code: api.CanonicalCode.UNKNOWN,
            ...
            try {
                ...
                const etag = typeof skillset === "string"
                    ...
                    : options.onlyIfUnchanged
                        ? skillset.etag
                        : undefined;
                yield this.client.skillsets.delete(skillsetName, Object.assign(Object.assign({}, coreHttp.operationOptionsToRequestOptionsBase(updatedOptions)), { ifMatch: etag }));
            }
            catch (e) {
                span.setStatus({
                    code: api.CanonicalCode.UNKNOWN,
